...
extern bus_t bus;
/**
 * struct instruction_s - opcode and its functon
 * @opcode: the opcode
 * @f: function to run the opcode
...
ssize_t gerstdin(char **lineptr, int file);
...
void f_pcgar(stack_t **head, unsigned int counter);
